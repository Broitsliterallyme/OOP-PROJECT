...
RMAPI bool NearlyEqualVector2(const Vector2& v1, const Vector2& v2, float epsilon = 0.01f) {
    return (std::fabs(v1.x - v2.x) < epsilon) && (std::fabs(v1.y - v2.y) < epsilon);
}
RMAPI bool NearlyEqual(float f1, float f2, float epsilon = 0.01f) {
...
RMAPI Vector2 Vector2Perpendicular(Vector2 v)
{
